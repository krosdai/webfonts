...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@daihaus/lxgw-bright-tc@1.0.0/index.css" />
<style>
  body {
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@daihaus/lxgw-bright-tc@1.0.0/weight-400.css" />
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@daihaus/lxgw-bright-tc@1.0.0/400-normal.css" />
```
...
```sh
npm install ./daihaus-lxgw-bright-tc-1.0.0.tgz
```
