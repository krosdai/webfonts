...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@daihaus/lxgw-bright-tc@1.0.0/400-normal/result.css" />
```
...
```js
import "@daihaus/lxgw-bright-tc/index.css"; // or "@daihaus/lxgw-bright-tc/400-normal/result.css"
```
